      ...
      <div className="flex flex-col gap-1">
        ...
        {errors.cvv && (
          ...
          <div className="flex items-center gap-2 mt-4">
            <Image src="/klarna.png" alt="klarna" width={52} height={25} className="rounded-md" />
            <Image src="/cards.png" alt="cards" width={52} height={25} className="rounded-md" />
            <Image src="/stripe.png" alt="stripe" width={52} height={25} className="rounded-md" />
          </div>
      <button
              type="submit"
