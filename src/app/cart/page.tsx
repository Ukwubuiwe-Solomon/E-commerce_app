                ...
                <div className="flex gap-8">
                  ...
                  <div className="flex flex-col justify-between">
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-xs text-gray-500">SelectedColor:{" "}{item.selectedColor}</p>
                    </div>
                    <p className="font-medium">${item.price.toFixed(2)}</p>
                  </div>
                </div>
                    {/* DELETE BUTTON */}
                    <button onClick={()=>removeFromCart(item)} className="w-8 h-8 rounded-full bg-red-100 text-red-400 hover:bg-red-200 transition-all duration-300 flex items-center justify-center cursor-pointer">
